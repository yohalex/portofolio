...
const textOfDescription =
  "Je suis un Développeur d'Application Web ,spécialiste Javascript. N'hésitez pas à jeter un œil à mes derniers projets dans la section projets web .";
...
function clickNavBar(
  ...
  linkClicked.addEventListener("click", () => {
    console.log(linkClicked.classList.contains("display-contact"));
